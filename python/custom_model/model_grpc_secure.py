...
if __name__ == "__main__":
    ...
    model.load()
    server_key = open("./kserve_test_certs/server-key.pem", 'rb').read()
    server_cert = open("./kserve_test_certs/server-cert.pem", 'rb').read()
    ca_cert = open("./kserve_test_certs/ca-cert.pem", 'rb').read()
    ModelServer(
